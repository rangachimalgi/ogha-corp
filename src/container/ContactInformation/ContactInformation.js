        ...
        <div className={`section section-padding-t90-b100 ${classOption}`}>
            <div className="container shape-animate">
                <SectionTitle
                    ...
                    title="We are dedicated to revolutionizing lifestyles"
                    subTitle="Our team comprising perfectionists who love what they do and aspire to better themselves for you."
                />
