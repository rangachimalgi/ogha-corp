    ...
    return (
        <div className={`section section-padding-t90 section-padding-bottom ${classOption}`}>
            <div className="container">
                ...
                <SectionTitle
                    headingOption="fz-32"
                    title="Streamlined Easy Three-Step Operational Process"
                    subTitle="AEDs are highly portable and exceptionally user-friendly, designed for easy use by any individual. Simply follow the voice prompts and pictograms in three straightforward steps."
                />
